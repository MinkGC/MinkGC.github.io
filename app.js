...
let trackList = [
    {
        name: "Heather",
        artist: "Conan Gray",
        path: "./music/Conan Gray - Heather.mp3",
    },
    {
        name: "Amor Completo",
        artist: "Mon Laferte",
        path: "./music/Mon Laferte - Amor Completo.mp3",
    },
    {
        name: "Luna",
        artist: "Zoé",
        path: "./music/Zoé - Luna (MTV Unplugged).mp3",
    },
    {
        name: "Akureyri",
        artist: "Aitana y Sebastián Yatra",
        path: "./music/Aitana, Sebastián Yatra - Akureyri (Letra).mp3",
    },
    {
        name: "Que la luna sepa",
        artist: "Solamentedan",
        path: "./music/Que la luna sepa.mp3",
    },
    {
        name: "Empezaré a vivir",
        artist: "Danna Paola",
        path: "./music/Danna Paola - Cuándo empezaré a vivir (De EnredadosVideo Oficial).mp3",
    },
    {
        name: "Love in october",
        artist: "girl in red",
        path: "./music/girl in red - we fell in love in october.mp3",
    },
    {
        name: "Veo en ti la luz",
        artist: "Chayanne y Danna Paola",
        path: "./music/Chayanne, Danna Paola - Veo en ti la luz (De EnredadosVideo Oficial).mp3",
    },
    {
        name: "Sparks",
        artist: "Coldplay",
        path: "./music/Sparks.mp3",
    },
    {
        name: "Compartir",
        artist: "Carla Morrison",
        path: "./music/Carla Morrison    Compartir [Letra].mp3",
    },
];
